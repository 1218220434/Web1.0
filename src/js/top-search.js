...
map.centerAndZoom(new BMap.Point(103.824042, 30.630206), 12); // 初始化地图,用城市名设置地图中心点
map.enableScrollWheelZoom(); // 缩放功能
var is = new BMap.LocalSearch("成都市")

console.log(is)
var _point = new BMap.Point(104.064042, 30.630206);
var marker = new BMap.Marker(_point); // 创建标注
map.addOverlay(marker); // 将标注添加到地图中
var _point = new BMap.Point(104.064482, 30.587915);
var marker = new BMap.Marker(_point); // 创建标注
